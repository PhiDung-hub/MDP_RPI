...
class RaspberryPi:
    ...
    def __init__(self):
        ...
        self.movement_lock = Semaphore(1)
    ...
    def recv_android(self) -> None:
        ...
        while True:
            ...
            if int(image_2) == 39:  # Left
                self.command_queue.put("FL000")  # +20
                self.command_queue.put("FW050")  # +60
                # if int(image_1) == 39:
                #     self.command_queue.put("FW030")  # +60
                # else:
                #     self.command_queue.put("FW080")  # +60
                self.command_queue.put("FR000")  # +70
                self.command_queue.put("FW010")  # -50
                self.command_queue.put("FR000")  # +50
                self.command_queue.put("FW110")  # -50
                self.command_queue.put("FR000")  # -60

            elif int(image_2) == 38:  # Right
                self.command_queue.put("FR000")  # +20
                self.command_queue.put("FW050")  # +60
                # if int(image_1) == 39:
                #     self.command_queue.put("FW030")  # +60
                # else:
                #     self.command_queue.put("FW080")  # +60
                self.command_queue.put("FL000")  # +70
                self.command_queue.put("FW010")  # -50
                self.command_queue.put("FR000")  # +50
                self.command_queue.put("FW110")  # -50
                self.command_queue.put("FR000")  # -60
            ...
            # if len(self.dists) < 2:
            #     self.logger.error("COULDNT CAPTURE BOTH IMAGE")
            #     raise Exception("TRY AGAIN!!!!!!")
            # backward = (self.dists[0] + self.dists[1])

            self.command_queue.put("FW150")  # -10
    ...
    def command_follower(self) -> None:
        ...
        """
        while True:
            if self.movement_lock.get_value() != 1:
                continue
